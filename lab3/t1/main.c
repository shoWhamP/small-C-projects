...
int main(int argc, char **argv){
 ...
 // strcpy(carray, "");
  ...
  struct fun_desc menu[] = { {"load signatures", load_sig},{"Print signatures", print_sig},{"detect virus", detect_v},{"print above80", unseen},{"quit",list_free},{NULL,NULL}};
